...
final class BehavGroup implements QueueWakeBehavior {
  ...
  public void finishExec() {
    ...
    new GroupExecFinisher(commandReq.getCmdGroup(), commandReq.getGroupElemList(),
        _factory._dataCache, _factory._idGenState, _factory._dataRef, _factory._saveRef,
        commandReq.getRemoteRef(), commandReq.getCommandKit().getParentMap(), _factory._lujbean)
        .finish();
  }
