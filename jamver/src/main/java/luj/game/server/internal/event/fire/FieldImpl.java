...
import luj.game.server.api.data.GameDataCommand.EventOld.FieldOld;
import luj.game.server.internal.event.instance.EventBuilderProxy;

final class FieldImpl implements FieldOld {
  ...
  @Override
  public <T> FieldOld set(Supplier<T> field, T value) {
